...
namespace Bestys\Purchases;

use GuzzleHttp\Client;
use GuzzleHttp\Exception\GuzzleException;
use Bestys\AppStore\ClientFactory as AppStoreClientFactory;
use Bestys\AppStore\Receipts\ReceiptResponse;
use Bestys\AppStore\Receipts\Verifier;
use Bestys\GooglePlay\ClientFactory as GooglePlayClientFactory;
use Bestys\GooglePlay\Subscriptions\Subscription as GooglePlaySubscription;
